...
public class NavegacionUsuarioTemplate extends JPanel{
    ...
    public void crearJPanels(){
        ...
        this.pSuperior = sObjGraficos.construirJPanel(
            0, 0, 270, 140, sRecursos.getColorFondo(), null
        );
        this.add(pSuperior);
        
        this.pMedio = sObjGraficos.construirJPanel(
            0, 140, 270, 165, sRecursos.getColorFondo(), null
        );
        this.add(pMedio);
                

        this.pInferior = sObjGraficos.construirJPanel(
            0, 305, 270, 345, sRecursos.getColorFondo(), null
        );
        this.add(pInferior);
    }
    ...
    public void crearJButtons(){
        ...
        this.bBrowse = sObjGraficos.construirJButton(
            ...
            iDimAux, sRecursos.getFontNavegacion(), null, colorNav, null, "l", false
        );
    ...
    private void crearJTextFields(){
        tBuscar = sObjGraficos.construirJTextField(
                "Buscar", 55, (pSuperior.getHeight()-25)/2+15, 175, 25, sRecursos.getColorGris(), 
                colorNav, colorNav, sRecursos.getFontNavegacion(), null, "c"
        );
    ...
    public void crearJLabels(){
        ...
        this.lMain = sObjGraficos.construirJLabel(
            "MAIN", 15, 5, 30, 20, null, colorNav, null, fontAuxiliar
        );
        this.pMedio.add(lMain);
        
        // LABEL YOUR MUSIC--------------------------------------------------------------------
        this.lYourMusic = sObjGraficos.construirJLabel(
            "YOUR MUSIC", 15, 5, 70, 20, null, colorNav, null, fontAuxiliar
        );
