...
public class VistaPrincipalTemplate extends JFrame{
    ...
    public void crearJPanels(){
        pNavegacion = sObjGraficos.construirJPanel(0, 0, 270, 650, null, null);
        this.add(pNavegacion);

        pBarra = sObjGraficos.construirJPanel(270, 540, 930, 110, Color.BLACK, null);
        this.add(pBarra);

        pPrincipal = sObjGraficos.construirJPanel(270, 0, 930, 540, null, null);
        this.add(pPrincipal);
    }
